...
class 7R_adf_uniform : U_I_E_Uniform_01_F
{
	...
	//picture = "\7R Factions\7R_factions_adf\data\icons\_ca.paa"
	model = "\A3\Characters_F\Common\Suitpacks\suitpack_original_F.p3d";
	hiddenSelections[] = {"camo"};
	hiddenSelectionsTextures[] = {"\7R Factions\7R_factions_adf\data\adf_camo_512.paa"};
	picture = "\7R Factions\7R_factions_adf\data\icons\7R_adf_uniform_ca.paa";
...
class 7R_adf_uniform_ssl : U_I_E_Uniform_01_F
{
	...
	hiddenSelections[] = {"camo"};
	hiddenSelectionsTextures[] = {"\7R Factions\7R_factions_adf\data\adf_camo_512.paa"};
	picture = "\7R Factions\7R_factions_adf\data\icons\7R_adf_uniform_ssl_ca.paa";
...
class 7R_adf_uniform_tank_top : U_I_E_Uniform_01_F
{
	...
	hiddenSelections[] = {"camo"};
	hiddenSelectionsTextures[] = {"\7R Factions\7R_factions_adf\data\adf_camo_512.paa"};
	picture = "\7R Factions\7R_factions_adf\data\icons\7R_adf_uniform_tank_top_ca.paa";
