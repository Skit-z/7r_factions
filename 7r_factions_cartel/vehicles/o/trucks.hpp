class 7r_cartel_o_ural_open : rhssaf_army_ural_open_copy{
	faction = "7r_cartel_o";
	side = 0;
...
class 7r_cartel_o_ural : rhssaf_army_ural_copy{
	faction = "7r_cartel_o";
	side = 0;
...
class 7r_cartel_o_ural_fuel : rhssaf_army_ural_fuel_copy{
	faction = "7r_cartel_o";
	side = 0;
